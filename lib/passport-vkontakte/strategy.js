 ...
 *   - `profileFields` array of fields to fetch in userProfile()  after successful authorization
 *
 * Examples:
 *
...
function Strategy(options, verify) {
  ...
  this.name = 'vkontakte';
  this.profileFields = [
      'uid', 'first_name', 'last_name', 'screen_name', 'sex', 'photo'
  ].concat(options.profileFields || []);
}
...
Strategy.prototype.userProfile = function(accessToken, uid, done) {
  var fields = this.profileFields.join(',');
